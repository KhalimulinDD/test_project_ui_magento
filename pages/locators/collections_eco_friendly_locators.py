...
men_bottoms_shorts_loc = (By.XPATH, '//*[@id="ui-id-24"]')
text_shorts_loc = (By.CSS_SELECTOR, '.base')
...
sorted_goods_price_loc = (
    By.XPATH, '//*[@class="product details product-item-details"]/descendant::span[@class="price"]'
)
